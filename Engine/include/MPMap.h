...
protected:
    ...
    float                       _fHeightBuffer[400][400];
    BYTE                        _btBlockBuffer[400][400];
	float						_fTileHeightBuffer[200][200];
	short						_sTileRegionAttr[200][200];
	...
	std::unique_ptr<std::byte[]> m_pMapData;
